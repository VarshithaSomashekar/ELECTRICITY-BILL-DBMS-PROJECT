...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($conn,"select admin_id from admin where  UserName='$a_email_id' && Password='$e_password' ");
...
<head>
    ...
    <title>Login - ELECTRICITY BILL</title>
            ...
            <div class="login-box ptb--100">
                <form action="#" method="post" name="login">
                    ...
                    <div class="login-form-head">
                        <h4>ADMIN LOGIN</h4>
                        <p>Sign in to view customers</p>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputEmail1">User Name</label>
                            <input type="text" id="a_email_id" name="a_email_id" required="true">
                            <i class="ti-user"></i>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" id="e_password" name="e_password" required="true">
                            <i class="ti-lock"></i>
                        </div>
